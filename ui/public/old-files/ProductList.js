...
function (_React$Component) {
  ...
  _createClass(ProductList, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                query = "query {\n            productList {\n                id\n                productName\n                price\n                category\n                imageUrl\n            }\n        }";
                _context.next = 3;
                return (0, _graphQLFetch.graphQLFetch)(query);
    ...
    value: function render() {
      return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("h1", null, "Product Tracker"), _react["default"].createElement(ProductFilter, null), _react["default"].createElement("hr", null), _react["default"].createElement(_ProductTable["default"], {
        products: this.state.products
      }), _react["default"].createElement("hr", null), _react["default"].createElement(_ProductAdd["default"], {
